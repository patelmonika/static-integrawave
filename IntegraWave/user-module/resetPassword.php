                            ...
                            <fieldset>
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="email" autofocus="" placeholder="E-mail" name="email"
                                               class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <button type="submit" class="btn btn-lg btn-primary btn-block" name="action"
                                            value="reset">Send My Password
                                    </button>
                                    <button type="button" class="btn btn-link btn-grey"
                                            onclick="location.href = '../index.php'">Back to Login
                                    </button>
                                </div>
                            </fieldset>
                        </form>
